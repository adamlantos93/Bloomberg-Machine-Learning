...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        # TODO
        self.regularization=nodes.L2NormPenaltyNode(l2_reg=self.l2_reg, w=self.w, node_name="regularization")
        self.loss_function=nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y, node_name="loss")
        self.obj_function=nodes.SumNode(a=self.regularization, b=self.loss_function, node_name="objective")
